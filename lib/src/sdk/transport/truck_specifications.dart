...
class TruckSpecifications {
  ...
  TruckSpecifications.withDefaults()
      : grossWeightInKilograms = null, weightPerAxleInKilograms = null, weightPerAxleGroup = null, heightInCentimeters = null, widthInCentimeters = null, lengthInCentimeters = null, axleCount = null, trailerCount = null, truckType = TruckType.straight, isTruckLight = false, payloadCapacityInKilograms = null, trailerAxleCount = null;
  @override
...
final _sdkTransportTruckspecificationsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint32, Uint8, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, int, Pointer<Void>, Pointer<Void>)
...
final _sdkTransportTruckspecificationsGetFieldtrailerAxleCount = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_transport_TruckSpecifications_get_field_trailerAxleCount'));
...
TruckSpecifications sdkTransportTruckspecificationsFromFfi(Pointer<Void> handle) {
  ...
  final _trailerAxleCountHandle = _sdkTransportTruckspecificationsGetFieldtrailerAxleCount(handle);
  try {
