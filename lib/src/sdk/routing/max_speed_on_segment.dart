...
class MaxSpeedOnSegment {
  ...
  /// The segment IDs are the same that are also used by, for example, the [Routing REST API](https://www.here.com/docs/bundle/routing-api-developer-guide-v8/page/topics/use-cases/avoid-segments.html).
