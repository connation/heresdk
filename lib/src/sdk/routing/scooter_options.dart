...
class ScooterOptions {
  ...
  ScooterOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.tollOptions, this.maxSpeedOnSegments, this.allowHighway, this.engineSizeInCubicCentimeters);
  ScooterOptions()
    : routeOptions = RouteOptions.withDefaults(), textOptions = RouteTextOptions(), avoidanceOptions = AvoidanceOptions(), tollOptions = TollOptions(), maxSpeedOnSegments = [], allowHighway = false, engineSizeInCubicCentimeters = null;
  @override
...
Pointer<Void> sdkRoutingScooteroptionsToFfi(ScooterOptions value) {
  ...
  final _result = _sdkRoutingScooteroptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _tollOptionsHandle, _maxSpeedOnSegmentsHandle, _allowHighwayHandle, _engineSizeInCubicCentimetersHandle);
