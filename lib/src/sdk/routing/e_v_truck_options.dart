...
class EVTruckOptions {
  ...
  EVTruckOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.tollOptions, this.maxSpeedOnSegments, this.truckSpecifications, this.linkTunnelCategory, this.hazardousMaterials, this.avoidedTruckRoadTypes, this.consumptionModel);
  EVTruckOptions()
    : routeOptions = RouteOptions.withDefaults(), textOptions = RouteTextOptions(), avoidanceOptions = AvoidanceOptions(), tollOptions = TollOptions(), maxSpeedOnSegments = [], truckSpecifications = TruckSpecifications(), linkTunnelCategory = null, hazardousMaterials = [], avoidedTruckRoadTypes = [], consumptionModel = EVConsumptionModel();
  @override
...
Pointer<Void> sdkRoutingEvtruckoptionsToFfi(EVTruckOptions value) {
  ...
  final _result = _sdkRoutingEvtruckoptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _tollOptionsHandle, _maxSpeedOnSegmentsHandle, _truckSpecificationsHandle, _linkTunnelCategoryHandle, _hazardousMaterialsHandle, _avoidedTruckRoadTypesHandle, _consumptionModelHandle);
