...
class BusOptions {
  ...
  BusOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.tollOptions, this.maxSpeedOnSegments, this.busSpecifications);
  /// Creates a new instance.
  BusOptions()
...
Pointer<Void> sdkRoutingBusoptionsToFfi(BusOptions value) {
  ...
  final _result = _sdkRoutingBusoptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _tollOptionsHandle, _maxSpeedOnSegmentsHandle, _busSpecificationsHandle);
