...
class ViolatedRestrictionDetails {
  ...
  /// .           indicated on a road sign.
  /// Additional legal restrictions might apply when transporting hazardous materials.
...
final _sdkRoutingViolatedrestrictionDetailsGetFieldtimeRule = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_ViolatedRestriction_Details_get_field_timeRule'));
...
ViolatedRestrictionDetails sdkRoutingViolatedrestrictionDetailsFromFfi(Pointer<Void> handle) {
  ...
  final _timeRuleHandle = _sdkRoutingViolatedrestrictionDetailsGetFieldtimeRule(handle);
  try {
