...
class RoutePlace {
  ...
  GeoCoordinates? displayCoordinates;
  ...
  /// [displayCoordinates] Location of the Points of Interest (PoI) to be displayed in the visualization.
  /// In the map data, PoI have a set of display coordinates as well as a set of access/routing coordinates.
  /// While the access/routing coordinates specify the nearest accessible road network location
  /// that can be apart from actual location of the PoI,
  /// the display coordinates specify the location of the PoI to be displayed accurately in the visualization.
  ...
  RoutePlace._(this.type, this.waypointIndex, this.originalCoordinates, this.mapMatchedCoordinates, this.displayCoordinates, this.chargeInKilowattHours, this.chargingStation, this.name, this.id, this.platform, this.sideOfDestination, this._indoorLocation);
  RoutePlace(RoutePlaceType type, GeoCoordinates mapMatchedCoordinates)
    : type = type, waypointIndex = null, originalCoordinates = null, mapMatchedCoordinates = mapMatchedCoordinates, displayCoordinates = null, chargeInKilowattHours = null, chargingStation = null, name = null, id = null, platform = null, sideOfDestination = null, _indoorLocation = null;
  ...
  int get hashCode {
    ...
    result = 31 * result + displayCoordinates.hashCode;
...
final _sdkRoutingRouteplaceCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>)
...
final _sdkRoutingRouteplaceGetFielddisplayCoordinates = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_RoutePlace_get_field_displayCoordinates'));
...
Pointer<Void> sdkRoutingRouteplaceToFfi(RoutePlace value) {
  ...
  final _displayCoordinatesHandle = sdkCoreGeocoordinatesToFfiNullable(value.displayCoordinates);
  ...
  final _result = _sdkRoutingRouteplaceCreateHandle(_typeHandle, _waypointIndexHandle, _originalCoordinatesHandle, _mapMatchedCoordinatesHandle, _displayCoordinatesHandle, _chargeInKilowattHoursHandle, _chargingStationHandle, _nameHandle, _idHandle, _platformHandle, _sideOfDestinationHandle, _indoorLocationHandle);
  ...
  sdkCoreGeocoordinatesReleaseFfiHandleNullable(_displayCoordinatesHandle);
...
RoutePlace sdkRoutingRouteplaceFromFfi(Pointer<Void> handle) {
  ...
  final _displayCoordinatesHandle = _sdkRoutingRouteplaceGetFielddisplayCoordinates(handle);
  ...
  try {
    return RoutePlace._(
      ...
      sdkCoreGeocoordinatesFromFfiNullable(_displayCoordinatesHandle), 
