...
class Waypoint {
  ...
  Waypoint(GeoCoordinates coordinates, [WaypointType type = WaypointType.stopover, int transitRadiusInMeters = 0, double? headingInDegrees = null, GeoCoordinates? sideOfStreetHint = null, GeoCoordinates? displayLocation = null, int? minCourseDistanceInMeters = null, String? nameHint = null, MatchSideOfStreet? matchSideOfStreet = null, Duration duration = const Duration(seconds: 0), SegmentReference? segmentHint = null, int? onRoadThresholdInMeters = null])
    : coordinates = coordinates, type = type, transitRadiusInMeters = transitRadiusInMeters, headingInDegrees = headingInDegrees, sideOfStreetHint = sideOfStreetHint, displayLocation = displayLocation, minCourseDistanceInMeters = minCourseDistanceInMeters, nameHint = nameHint, matchSideOfStreet = matchSideOfStreet, duration = duration, segmentHint = segmentHint, onRoadThresholdInMeters = onRoadThresholdInMeters;
  /// Creates a new instance.
  /// [coordinates] The waypoint's geographic coordinates.
  Waypoint.withDefaults(this.coordinates)
      : type = WaypointType.stopover, transitRadiusInMeters = 0, headingInDegrees = null, sideOfStreetHint = null, displayLocation = null, minCourseDistanceInMeters = null, nameHint = null, matchSideOfStreet = null, duration = const Duration(seconds: 0), segmentHint = null, onRoadThresholdInMeters = null;
  @override
...
final _sdkRoutingWaypointCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Uint32, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint64, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, int, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>)
