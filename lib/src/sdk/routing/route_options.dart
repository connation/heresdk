...
class RouteOptions {
  ...
  /// Valid only for Car, Truck, Bus and Scooter transport mode. Shouldn't be less than 1 or greater than 255. Defaults to 1.
  ...
  RouteOptions([OptimizationMode optimizationMode = OptimizationMode.fastest, int alternatives = 0, DateTime? departureTime = null, DateTime? arrivalTime = null, double? speedCapInMetersPerSecond = null, bool enableRouteHandle = false, TrafficOptimizationMode trafficOptimizationMode = TrafficOptimizationMode.timeDependent, bool enableTolls = false, int occupantsNumber = 1, bool optimizeWaypointsOrder = false])
    : optimizationMode = optimizationMode, alternatives = alternatives, departureTime = departureTime, arrivalTime = arrivalTime, speedCapInMetersPerSecond = speedCapInMetersPerSecond, enableRouteHandle = enableRouteHandle, trafficOptimizationMode = trafficOptimizationMode, enableTolls = enableTolls, occupantsNumber = occupantsNumber, optimizeWaypointsOrder = optimizeWaypointsOrder;
  /// Creates a new instance.
  RouteOptions.withDefaults()
      : optimizationMode = OptimizationMode.fastest, alternatives = 0, departureTime = null, arrivalTime = null, speedCapInMetersPerSecond = null, enableRouteHandle = false, trafficOptimizationMode = TrafficOptimizationMode.timeDependent, enableTolls = false, occupantsNumber = 1, optimizeWaypointsOrder = false;
  @override
...
final _sdkRoutingRouteoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Uint32, Uint8, Int32, Uint8),
    Pointer<Void> Function(int, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, int, int, int, int)
...
Pointer<Void> sdkRoutingRouteoptionsToFfi(RouteOptions value) {
  ...
  final _result = _sdkRoutingRouteoptionsCreateHandle(_optimizationModeHandle, _alternativesHandle, _departureTimeHandle, _arrivalTimeHandle, _speedCapInMetersPerSecondHandle, _enableRouteHandleHandle, _trafficOptimizationModeHandle, _enableTollsHandle, _occupantsNumberHandle, _optimizeWaypointsOrderHandle);
