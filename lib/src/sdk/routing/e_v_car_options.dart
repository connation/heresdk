...
class EVCarOptions {
  ...
  EVCarOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.tollOptions, this.maxSpeedOnSegments, this.ensureReachability, this.consumptionModel, this.batterySpecifications, this.carSpecifications);
  EVCarOptions()
    : routeOptions = RouteOptions.withDefaults(), textOptions = RouteTextOptions(), avoidanceOptions = AvoidanceOptions(), tollOptions = TollOptions(), maxSpeedOnSegments = [], ensureReachability = false, consumptionModel = EVConsumptionModel(), batterySpecifications = BatterySpecifications.withDefaults(), carSpecifications = CarSpecifications();
  @override
...
final _sdkRoutingEvcaroptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Pointer<Void>),
...
Pointer<Void> sdkRoutingEvcaroptionsToFfi(EVCarOptions value) {
  ...
  final _result = _sdkRoutingEvcaroptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _tollOptionsHandle, _maxSpeedOnSegmentsHandle, _ensureReachabilityHandle, _consumptionModelHandle, _batterySpecificationsHandle, _carSpecificationsHandle);
