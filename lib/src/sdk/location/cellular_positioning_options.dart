...
class CellularPositioningOptions {
  ...
  /// [enabled] Controls cellular positioning. If false, cellular positioning is disabled.
  /// Defaults to true.

  CellularPositioningOptions._(this.enabled);
...
CellularPositioningOptions sdkLocationCellularpositioningoptionsFromFfi(Pointer<Void> handle) {
  ...
  try {
    return CellularPositioningOptions._(
