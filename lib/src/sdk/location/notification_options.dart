...
class NotificationOptions {
  ...
  /// [desiredIntervalMilliseconds] Desired interval for position updates in milliseconds. This interval
  /// is not guaranteed.
  /// Default interval is 30 seconds.

  /// [smallestIntervalMilliseconds] Smallest allowed interval for position updates in milliseconds.  It is
  /// guaranteed that positions are not provided more often than this value.
  /// Smallest interval could be used for throttling position updates, e.g.
  /// when each position update triggers CPU intensive calculations in the
  /// client application.
  ...
  NotificationOptions._(this.desiredIntervalMilliseconds, this.smallestIntervalMilliseconds);
  NotificationOptions()
    : desiredIntervalMilliseconds = 30000, smallestIntervalMilliseconds = 900;
}
