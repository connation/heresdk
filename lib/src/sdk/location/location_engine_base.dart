...
import 'package:here_sdk/src/sdk/location/location_issue_listener.dart';
...
abstract class LocationEngineBase {
  ...
  /// Creates instance of `LocationEngine` using factory, registered on platform side
  ///
  static LocationEngineBase makeLocationEngineFromSharedSdkNativeEngine() => $prototype.makeLocationEngineFromSharedSdkNativeEngine();
  ...
  /// @nodoc
  @visibleForTesting
  static dynamic $prototype = LocationEngineBase$Impl(Pointer<Void>.fromAddress(0));
}
...
final _sdkLocationLocationenginebaseCreateProxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint64, Int32, Handle, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer),
    Pointer<Void> Function(int, int, Object, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer)
...
final _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_release_handle'));
final _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_get_result'));
final _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_get_error'));
final _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine_return_has_error'));


final _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_release_handle'));
final _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_get_result'));
final _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_get_error'));
final _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine_return_has_error'));
...
class LocationEngineBase$Lambdas implements LocationEngineBase {
  ...
  LocationEngineBase$Lambdas(
    ...
    this.addLocationIssueListenerLambda,
    this.removeLocationIssueListenerLambda,
    ...
    this.internalsetCallListenerFromMainThreadEnabledLambda,
  ...
  @override
  void addLocationIssueListener(LocationIssueListener listener) =>
    addLocationIssueListenerLambda(listener);
  @override
  void removeLocationIssueListener(LocationIssueListener listener) =>
    removeLocationIssueListenerLambda(listener);
  @override
  LocationEngineStatus setBackgroundLocationAllowed(bool allowed) =>
  ...
  @override
  void internalsetCallListenerFromMainThreadEnabled(bool enabled) =>
    internalsetCallListenerFromMainThreadEnabledLambda(enabled);
  @override
...
class LocationEngineBase$Impl extends __lib.NativeBase implements LocationEngineBase {
  ...
  @override
  void addLocationIssueListener(LocationIssueListener listener) {
    final _addLocationIssueListenerFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_location_LocationEngineBase_addLocationIssueListener__LocationIssueListener'));
    final _listenerHandle = sdkLocationLocationissuelistenerToFfi(listener);
    final _handle = this.handle;
    _addLocationIssueListenerFfi(_handle, __lib.LibraryContext.isolateId, _listenerHandle);
    sdkLocationLocationissuelistenerReleaseFfiHandle(_listenerHandle);

  }

  @override
  void removeLocationIssueListener(LocationIssueListener listener) {
    final _removeLocationIssueListenerFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_location_LocationEngineBase_removeLocationIssueListener__LocationIssueListener'));
    final _listenerHandle = sdkLocationLocationissuelistenerToFfi(listener);
    final _handle = this.handle;
    _removeLocationIssueListenerFfi(_handle, __lib.LibraryContext.isolateId, _listenerHandle);
    sdkLocationLocationissuelistenerReleaseFfiHandle(_listenerHandle);
  ...
  @override
  void internalsetCallListenerFromMainThreadEnabled(bool enabled) {
    final _internalsetCallListenerFromMainThreadEnabledFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Uint8), void Function(Pointer<Void>, int, int)>('here_sdk_sdk_location_LocationEngineBase_setCallListenerFromMainThreadEnabled__Boolean'));
    final _enabledHandle = booleanToFfi(enabled);
    final _handle = this.handle;
    _internalsetCallListenerFromMainThreadEnabledFfi(_handle, __lib.LibraryContext.isolateId, _enabledHandle);
    booleanReleaseFfiHandle(_enabledHandle);

  }

  LocationEngineBase makeLocationEngine(SDKNativeEngine sdkEngine) {
    final _makeLocationEngineFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>)>('here_sdk_sdk_location_LocationEngineBase_makeLocationEngine__SDKNativeEngine'));
    final _sdkEngineHandle = sdkCoreEngineSdknativeengineToFfi(sdkEngine);
    final __callResultHandle = _makeLocationEngineFfi(__lib.LibraryContext.isolateId, _sdkEngineHandle);
    sdkCoreEngineSdknativeengineReleaseFfiHandle(_sdkEngineHandle);
    if (_makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnGetError(__callResultHandle);
        _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnGetResult(__callResultHandle);
    _makeLocationEnginesdkLocationLocationenginebaseMakelocationengineSdknativeengineReturnReleaseHandle(__callResultHandle);
    try {
      return sdkLocationLocationenginebaseFromFfi(__resultHandle);
    } finally {
      sdkLocationLocationenginebaseReleaseFfiHandle(__resultHandle);

    }

  }

  LocationEngineBase makeLocationEngineFromSharedSdkNativeEngine() {
    final _makeLocationEngineFromSharedSdkNativeEngineFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32), Pointer<Void> Function(int)>('here_sdk_sdk_location_LocationEngineBase_makeLocationEngineFromSharedSdkNativeEngine'));
    final __callResultHandle = _makeLocationEngineFromSharedSdkNativeEngineFfi(__lib.LibraryContext.isolateId);
    if (_makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnGetError(__callResultHandle);
        _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnGetResult(__callResultHandle);
    _makeLocationEngineFromSharedSdkNativeEnginesdkLocationLocationenginebaseMakelocationenginefromsharedsdknativeengineReturnReleaseHandle(__callResultHandle);
    try {
      return sdkLocationLocationenginebaseFromFfi(__resultHandle);
    } finally {
...
int _sdkLocationLocationenginebaseaddLocationIssueListenerStatic(Object _obj, Pointer<Void> listener) {

  try {
    (_obj as LocationEngineBase).addLocationIssueListener(sdkLocationLocationissuelistenerFromFfi(listener));
  } finally {
    sdkLocationLocationissuelistenerReleaseFfiHandle(listener);
  }
  return 0;
}
int _sdkLocationLocationenginebaseremoveLocationIssueListenerStatic(Object _obj, Pointer<Void> listener) {

  try {
    (_obj as LocationEngineBase).removeLocationIssueListener(sdkLocationLocationissuelistenerFromFfi(listener));
  } finally {
    sdkLocationLocationissuelistenerReleaseFfiHandle(listener);
  }
  return 0;
...
int _sdkLocationLocationenginebaseinternalsetCallListenerFromMainThreadEnabledStatic(Object _obj, int enabled) {
...
Pointer<Void> sdkLocationLocationenginebaseToFfi(LocationEngineBase value) {
  ...
  final result = _sdkLocationLocationenginebaseCreateProxy(
    ...
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Void>)>(_sdkLocationLocationenginebaseaddLocationIssueListenerStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Void>)>(_sdkLocationLocationenginebaseremoveLocationIssueListenerStatic, __lib.unknownError),
    ...
    Pointer.fromFunction<Uint8 Function(Handle, Uint8)>(_sdkLocationLocationenginebaseinternalsetCallListenerFromMainThreadEnabledStatic, __lib.unknownError),
