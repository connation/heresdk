...
/// Please [contact us](https://www.here.com/docs/bundle/lidar-data-user-guide/page/topics/need-help.html)
...
class EVChargingPool {
  ...
  EVChargingPool._(this.chargingStations, this.eMobilityServiceProviders, this.details, this.cpoId, this.evseInfo);
  EVChargingPool(List<EVChargingStation> chargingStations, List<EMobilityServiceProvider> eMobilityServiceProviders)
    : chargingStations = chargingStations, eMobilityServiceProviders = eMobilityServiceProviders, details = null, cpoId = null, evseInfo = [];
  @override
...
Pointer<Void> sdkSearchEvchargingpoolToFfi(EVChargingPool value) {
  ...
  final _result = _sdkSearchEvchargingpoolCreateHandle(_chargingStationsHandle, _eMobilityServiceProvidersHandle, _detailsHandle, _cpoIdHandle, _evseInfoHandle);
