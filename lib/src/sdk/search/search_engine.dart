...
abstract class SearchEngine {
  ...
  ///   **Note:** Only clients with a license with TripAdvisor for rich content will actually get it.
  ...
  ///   they will be missing rich TripAdvisor content.
  ...
  /// - name = "discover.ranking" or "browse.ranking", value = "excursionDistance"
  ///   enables balanced distribution of results for search in `GeoCorridor`.
  ///   **Note:** Only participants of the closed-alpha group can get access from HERE to use this feature,
  ///   otherwise, a [SearchError.forbidden] will be propagated in callbacks.
  ///   For a complete list of available endpoints, parameter names and their valid values, refer to
  ///   [HERE Geocoding & Search API v7](https://www.here.com/docs/bundle/batch-api-developer-guide/page/topics/constructing-request.html).
