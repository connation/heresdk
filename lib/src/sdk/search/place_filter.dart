...
class PlaceFilterEv {
  ...
  PlaceFilterEv._(this.supplierNames, this.connectorTypeIDs, this.minPowerInKilowatts, this.eMobilityServiceProviderPartnerIDs);
  PlaceFilterEv()
    : supplierNames = [], connectorTypeIDs = [], minPowerInKilowatts = null, eMobilityServiceProviderPartnerIDs = [];
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
...
Pointer<Void> sdkSearchPlacefilterEvToFfi(PlaceFilterEv value) {
  ...
  final _result = _sdkSearchPlacefilterEvCreateHandle(_supplierNamesHandle, _connectorTypeIDsHandle, _minPowerInKilowattsHandle, _eMobilityServiceProviderPartnerIDsHandle);
