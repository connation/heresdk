...
class SDKOptions {
  ...
  /// see also [Manage Projects](https://www.here.com/docs/bundle/identity-and-access-management-developer-guide/page/topics/manage-projects.html)
  /// and [IAM Concepts](https://www.here.com/docs/bundle/identity-and-access-management-developer-guide/page/topics/concepts.html)
  String scope;
  ...
  @Deprecated("Will be removed in future releases. Please use [SDKOptions.customEngineOptions] instead")
  Map<EngineBaseURL, String> customEngineBaseUrls;

  /// Set custom options for SDK Engines. This includes:
  /// - `custom_base_url`: Allows engines to use custom base URLs for alternative services.
  ...
  /// - `custom_authentication_mode`: Enables bearer authentication mode for engines,
  ...
  /// [cost management guide](https://www.here.com/docs/bundle/cost-management-developer-guide/page/topics/tutorial-billing-tags.html).
  ...
  ///
  /// **Note:** The billing tag is optional, but when set, it can help you to understand
  ...
  bool operator ==(Object other) {
    ...
    return accessKeyId == _other.accessKeyId &&
        ...
        DeepCollectionEquality().equals(customEngineOptions, _other.customEngineOptions) &&
...
final _sdkCoreEngineSdkoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Int64, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Uint32, Pointer<Void>, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)
...
final _sdkCoreEngineSdkoptionsGetFieldcustomEngineOptions = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_core_engine_SDKOptions_get_field_customEngineOptions'));
...
Pointer<Void> sdkCoreEngineSdkoptionsToFfi(SDKOptions value) {
  ...
  final _customEngineOptionsHandle = heresdkCoreBindingsmapofSdkCoreEngineEnginebaseurlToSdkCoreEngineEngineoptionsToFfi(value.customEngineOptions);
  ...
  heresdkCoreBindingsmapofSdkCoreEngineEnginebaseurlToSdkCoreEngineEngineoptionsReleaseFfiHandle(_customEngineOptionsHandle);
...
SDKOptions sdkCoreEngineSdkoptionsFromFfi(Pointer<Void> handle) {
  ...
  final _customEngineOptionsHandle = _sdkCoreEngineSdkoptionsGetFieldcustomEngineOptions(handle);
  ...
  try {
    return SDKOptions._(
      ...
      heresdkCoreBindingsmapofSdkCoreEngineEnginebaseurlToSdkCoreEngineEngineoptionsFromFfi(_customEngineOptionsHandle), 
