...
class LocationInternal {
  ...
  LocationInternal(this.coordinates, this.bearingInDegrees, this.speedInMetersPerSecond, this.time, this.horizontalAccuracyInMeters, this.verticalAccuracyInMeters, this.bearingAccuracyInDegrees, this.speedAccuracyInMetersPerSecond, this.timestampSinceBoot, this.locationTechnology, this.gnssTime, this.pitchInDegrees);
  LocationInternal.withDefaults(GeoCoordinates coordinates)
    : coordinates = coordinates, bearingInDegrees = null, speedInMetersPerSecond = null, time = null, horizontalAccuracyInMeters = null, verticalAccuracyInMeters = null, bearingAccuracyInDegrees = null, speedAccuracyInMetersPerSecond = null, timestampSinceBoot = null, locationTechnology = null, gnssTime = null, pitchInDegrees = null;
}
