...
class PickedPlace {
  ...
  /// [offlineSearchId] The place ID to query an offline search to obtain additional data about this POI with
  /// the `OfflineSearchEngine`. Note that not all editions include the `OfflineSearchEngine`.

  PickedPlace._(this.name, this.coordinates, this.placeCategoryId, this.offlineSearchId);
  ...
  bool operator ==(Object other) {
    ...
    return name == _other.name &&
        ...
        offlineSearchId == _other.offlineSearchId;
  }
  ...
  int get hashCode {
    ...
    result = 31 * result + offlineSearchId.hashCode;
    return result;
  }
}
...
final _sdkCorePickedplaceGetFieldofflineSearchId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_core_PickedPlace_get_field_offlineSearchId'));
...
Pointer<Void> sdkCorePickedplaceToFfi(PickedPlace value) {
  ...
  final _result = _sdkCorePickedplaceCreateHandle(_nameHandle, _coordinatesHandle, _placeCategoryIdHandle, _offlineSearchIdHandle);
...
PickedPlace sdkCorePickedplaceFromFfi(Pointer<Void> handle) {
  ...
  final _offlineSearchIdHandle = _sdkCorePickedplaceGetFieldofflineSearchId(handle);
  try {
    return PickedPlace._(
