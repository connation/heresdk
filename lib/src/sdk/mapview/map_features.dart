...
class MapFeatures {
  ...
  /// [MapScheme.hybridNight], [MapScheme.roadNetworkDay] and [MapScheme.roadNetworkNight].
  ...
  ///
  /// Not supported for [MapScheme.satellite], [MapScheme.roadNetworkDay]
  /// and [MapScheme.roadNetworkNight].
  ...
  /// If the offline-mode is enabled for offline maps usage,
  /// the live traffic flow can still be shown in offline mode by enabling
  /// pass-through feature for traffic incidents on `sdk.core.engine.SDKNativeEngine`.
  /// See `sdk.core.engine.SDKNativeEngine.pass_through_features` for details.
  ///
  ...
  ///
  /// Supports only one mode: [MapFeatureModes.lowSpeedZonesAll].
  ///
  /// Not supported for [MapScheme.satellite], [MapScheme.roadNetworkDay]
  /// and [MapScheme.roadNetworkNight].
  static final String lowSpeedZones = "low speed zones";

  /// Show elevation topography.
  ///
  /// Supported modes: [MapFeatureModes.terrainHillshade],
  /// [MapFeatureModes.terrain3d].
  ///
  /// [MapFeatureModes.terrainHillshade] is only supported for schemes [MapScheme.normalDay],
  /// [MapScheme.normalNight], [MapScheme.liteDay], [MapScheme.liteNight]
  /// and [MapScheme.logisticsDay].
  ///
  /// Default mode is [MapFeatureModes.terrainHillshade] for the supporting schemes.
  /// [MapFeatureModes.terrain3d] for the others.
  ///
  /// Not supported for [MapScheme.satellite], [MapScheme.roadNetworkDay]
  /// and [MapScheme.roadNetworkNight].
