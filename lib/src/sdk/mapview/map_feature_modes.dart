...
class MapFeatureModes {
  ...
  static final String lowSpeedZonesAll = "all";
  ...
  static final String vehicleRestrictionsActive = "active only";
  ...
  static final String terrainHillshade = "hillshade";

  /// Topography-shading is shown on 3d terrain.
  /// Note: This is a beta release of this feature, so there could be a few bugs and unexpected
  /// behavior. Related APIs may change for new releases without a deprecation process.
  static final String terrain3d = "3d";
