...
abstract class IconProviderInternal {
  ...
  /// [mapScheme] The map scheme for which the road shield should be created.
  ///
  /// [widthConstraintInPixels] The maximum width of the icon in pixels. The image will be created to be as large as
  /// possible within the width and height constraint while keeping the aspect ratio. If
  /// set to 0 the icon width will be the maximum width resulting from keeping the aspect
  /// ratio and the heightConstraintInPixels parameter.
  ///
  /// [heightConstraintInPixels] The maximum height of the icon in pixels. The image will be created to be as large as
  /// possible within the width and height constraint while keeping the aspect ratio. If
  /// set to 0 then the actual image-asset's height is used.
  ///
  /// [callback] The callback which is used to return the created image or an error code.
  ///
  void createVehicleRestrictionIcon(IconProviderInternalVehicleRestrictionIconAttributes attributes, MapScheme mapScheme, int widthConstraintInPixels, int heightConstraintInPixels, IconProviderInternalCreateIconCallback callback);
...
class IconProviderInternal$Impl extends __lib.NativeBase implements IconProviderInternal {
  ...
  @override
  void createVehicleRestrictionIcon(IconProviderInternalVehicleRestrictionIconAttributes attributes, MapScheme mapScheme, int widthConstraintInPixels, int heightConstraintInPixels, IconProviderInternalCreateIconCallback callback) {
    final _createVehicleRestrictionIconFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Uint32, Uint32, Uint32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, int, int, int, Pointer<Void>)>('here_sdk_sdk_mapview_IconProviderInternal_createVehicleRestrictionIcon__VehicleRestrictionIconAttributes_MapScheme_UInt_UInt_CreateIconCallback'));
    ...
    final _callbackHandle = sdkMapviewIconproviderinternalCreateiconcallbackToFfi(callback);
    final _handle = this.handle;
    _createVehicleRestrictionIconFfi(_handle, __lib.LibraryContext.isolateId, _attributesHandle, _mapSchemeHandle, _widthConstraintInPixelsHandle, _heightConstraintInPixelsHandle, _callbackHandle);
