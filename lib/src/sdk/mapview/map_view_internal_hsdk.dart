...
class MapViewInternalHsdk$Impl extends __lib.NativeBase implements MapViewInternalHsdk {
  ...
  void pick(MapSceneMapPickFilter? filter, Rectangle2D viewArea, MapViewBaseMapPickCallback callback) {
    final _pickFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewInternalHsdk_pick__MapPickFilter__Rectangle2D_MapPickCallback'));
