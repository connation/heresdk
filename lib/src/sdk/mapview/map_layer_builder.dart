...
import 'package:here_sdk/src/sdk/mapview/map_layer_map_measure_dependent_storage_levels.dart';
...
abstract class MapLayerBuilder {
  ...
  /// Applies a mapping from the map measure to the storage level which is requested from the
  /// datasource for this layer.
  ///
  /// This can be used for example to fine-tune the resolution of raster
  /// layers. Please be aware that mappings that request higher storage levels will result in
  /// a larger number of requests to the raster tile service.
  ///
...
class MapLayerBuilder$Impl extends __lib.NativeBase implements MapLayerBuilder {
  ...
  @override
  MapLayerBuilder withMapMeasureDependentStorageLevels(MapLayerMapMeasureDependentStorageLevels mapLayerMapMeasureDependentStorageLevels) {
    final _withMapMeasureDependentStorageLevelsFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32, Pointer<Void>), Pointer<Void> Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapLayerBuilder_withMapMeasureDependentStorageLevels__MapLayerMapMeasureDependentStorageLevels'));
    final _mapLayerMapMeasureDependentStorageLevelsHandle = sdkMapviewMaplayermapmeasuredependentstoragelevelsToFfi(mapLayerMapMeasureDependentStorageLevels);
    final _handle = this.handle;
    final __resultHandle = _withMapMeasureDependentStorageLevelsFfi(_handle, __lib.LibraryContext.isolateId, _mapLayerMapMeasureDependentStorageLevelsHandle);
    sdkMapviewMaplayermapmeasuredependentstoragelevelsReleaseFfiHandle(_mapLayerMapMeasureDependentStorageLevelsHandle);
    try {
      return sdkMapviewMaplayerbuilderFromFfi(__resultHandle);
    } finally {
      sdkMapviewMaplayerbuilderReleaseFfiHandle(__resultHandle);
