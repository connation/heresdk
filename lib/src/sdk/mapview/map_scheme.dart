...
int sdkMapviewMapschemeToFfi(MapScheme value) {
  ...
  case MapScheme.logisticsDay:
    return 9;
  case MapScheme.logisticsNight:
    return 10;
  case MapScheme.logisticsHybridDay:
    return 11;
  case MapScheme.logisticsHybridNight:
    return 12;
...
MapScheme sdkMapviewMapschemeFromFfi(int handle) {
  ...
  case 10:
    return MapScheme.logisticsNight;
  case 11:
    return MapScheme.logisticsHybridDay;
  case 12:
    return MapScheme.logisticsHybridNight;
  case 13:
