...
import 'package:here_sdk/src/sdk/mapview/datasource/raster_tile_source.dart';
...
class RasterDataSource$Impl extends __lib.NativeBase implements RasterDataSource {
  ...
  RasterDataSource withTileSource(MapContext context, String name, RasterTileSource tileSource) {
    final _result_handle = _withTileSource(context, name, tileSource);
    final _result = RasterDataSource$Impl(_result_handle);
  ...
  RasterDataSource withTileSourceAndListener(MapContext context, String name, RasterTileSource tileSource, RasterDataSourceListener listener) {
    final _result_handle = _withTileSourceAndListener(context, name, tileSource, listener);
    final _result = RasterDataSource$Impl(_result_handle);
  ...
  static Pointer<Void> _withTileSource(MapContext context, String name, RasterTileSource tileSource) {
    final _withTileSourceFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_datasource_RasterDataSource_create__MapContext_String_RasterTileSource'));
    final _contextHandle = sdkMapviewMapcontextToFfi(context);
    final _nameHandle = stringToFfi(name);
    final _tileSourceHandle = sdkMapviewDatasourceRastertilesourceToFfi(tileSource);
    final __resultHandle = _withTileSourceFfi(__lib.LibraryContext.isolateId, _contextHandle, _nameHandle, _tileSourceHandle);
    sdkMapviewMapcontextReleaseFfiHandle(_contextHandle);
    stringReleaseFfiHandle(_nameHandle);
    sdkMapviewDatasourceRastertilesourceReleaseFfiHandle(_tileSourceHandle);
    return __resultHandle;
  }

  static Pointer<Void> _withTileSourceAndListener(MapContext context, String name, RasterTileSource tileSource, RasterDataSourceListener listener) {
    final _withTileSourceAndListenerFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_datasource_RasterDataSource_create__MapContext_String_RasterTileSource_RasterDataSourceListener'));
    final _contextHandle = sdkMapviewMapcontextToFfi(context);
    final _nameHandle = stringToFfi(name);
    final _tileSourceHandle = sdkMapviewDatasourceRastertilesourceToFfi(tileSource);
    final _listenerHandle = sdkMapviewDatasourceRasterdatasourcelistenerToFfi(listener);
    final __resultHandle = _withTileSourceAndListenerFfi(__lib.LibraryContext.isolateId, _contextHandle, _nameHandle, _tileSourceHandle, _listenerHandle);
    sdkMapviewMapcontextReleaseFfiHandle(_contextHandle);
    stringReleaseFfiHandle(_nameHandle);
    sdkMapviewDatasourceRastertilesourceReleaseFfiHandle(_tileSourceHandle);
    sdkMapviewDatasourceRasterdatasourcelistenerReleaseFfiHandle(_listenerHandle);
