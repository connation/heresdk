...
import 'heresdk_consent_localizations_sr.dart';
...
import 'heresdk_consent_localizations_vi.dart';
...
abstract class HereSdkConsentLocalizations {
  HereSdkConsentLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());
...
HereSdkConsentLocalizations _lookupHereSdkConsentLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'sr':
      return HereSdkConsentLocalizationsSr();
    case 'sv':
    ...
    case 'vi':
      return HereSdkConsentLocalizationsVi();
    case 'zh':
