...
enum PersistentMapRepairError {
    ...
    /// An unknown error occurred. Try to clear the persisted storage by calling [MapDownloader.clearPersistentMapStorage].
...
int sdkMaploaderPersistentmaprepairerrorToFfi(PersistentMapRepairError value) {
  ...
  case PersistentMapRepairError.noJournal:
    return 4;
  case PersistentMapRepairError.brokenUpdate:
    return 5;
  case PersistentMapRepairError.operationAfterDispose:
    return 6;
...
PersistentMapRepairError sdkMaploaderPersistentmaprepairerrorFromFfi(int handle) {
  ...
  case 5:
    return PersistentMapRepairError.brokenUpdate;
  case 6:
    return PersistentMapRepairError.operationAfterDispose;
  case 7:
