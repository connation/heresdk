...
enum PersistentMapStatus {
    ...
    /// To repair a map, call again [MapUpdater.updateCatalog] for the affected catalog.
    /// [MapUpdater.retrieveCatalogsUpdateInfo] returns a list of [CatalogUpdateInfo] items:
    /// The affected catalog can be identified by the state, which is set to [CatalogUpdateState.pendingUpdate].
    /// To know if a map needs to be repaired, check if [MapLoaderError.pendingUpdate] has occurred.
    pendingUpdate,
...
int sdkMaploaderPersistentmapstatusToFfi(PersistentMapStatus value) {
  ...
  case PersistentMapStatus.corrupted:
    return 1;
  case PersistentMapStatus.brokenUpdate:
    return 2;
  ...
  case PersistentMapStatus.invalidState:
    return 6;
  case PersistentMapStatus.storageClosed:
    return 7;
  default:
...
PersistentMapStatus sdkMaploaderPersistentmapstatusFromFfi(int handle) {
  ...
  case 2:
    return PersistentMapStatus.brokenUpdate;
  case 3:
  ...
  case 7:
    return PersistentMapStatus.storageClosed;
  default:
