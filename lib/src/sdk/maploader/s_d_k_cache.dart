...
abstract class SDKCache {
  ...
  /// The operation can have unexpected behaviour when it is called during a map interaction, during turn-by-turn navigation (if available for your edition) or
