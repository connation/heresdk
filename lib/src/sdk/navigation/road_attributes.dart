...
class RoadAttributes {
  ...
  /// [isNoThrough] Identifies a no through road. This can also be a part of the route you can only enter or leave if it’s a waypoint.
  ...
  /// [isRightDrivingSide] Indicates if vehicles have to drive on the right-hand side of the road or the left-hand side.
  /// For example, in New York it is always true and in London always false as the United Kingdom is
  /// a left-hand driving country.

  /// [isRoundabout] Indicates the presence of a roundabout.

  RoadAttributes._(this.isDirtRoad, this.isTunnel, this.isBridge, this.isRamp, this.isControlledAccess, this.isPrivate, this.isNoThrough, this.isTollway, this.isDividedRoad, this.isRightDrivingSide, this.isRoundabout);
  RoadAttributes()
