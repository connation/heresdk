...
@Deprecated("Will be removed in v4.20.0. Please use the method with [EventTextListener] listener instead.")
abstract class SpatialManeuverNotificationListener {
  ...
  ///
  @Deprecated("Will be removed in v4.20.0. Please use the method with [EventTextListener] class instead.")
