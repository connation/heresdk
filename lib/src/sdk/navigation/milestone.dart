...
import 'package:here_sdk/src/sdk/navigation/milestone_type.dart';
...
class Milestone {
  ...
  /// [waypointIndex] If present, this index corresponds to the waypoint in the original
  /// user-defined waypoint list. Otherwise this waypoint was added during
  /// route calculation by the system.
  /// [originalCoordinates] User-defined geographic coordinates. If not available, this waypoint was
  /// added during route calculation.
...
final _sdkNavigationMilestoneCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint32),
...
final _sdkNavigationMilestoneGetFieldtype = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_Milestone_get_field_type'));
...
Pointer<Void> sdkNavigationMilestoneToFfi(Milestone value) {
  ...
  final _typeHandle = sdkNavigationMilestonetypeToFfi(value.type);
  final _result = _sdkNavigationMilestoneCreateHandle(_sectionIndexHandle, _waypointIndexHandle, _originalCoordinatesHandle, _mapMatchedCoordinatesHandle, _typeHandle);
  ...
  sdkNavigationMilestonetypeReleaseFfiHandle(_typeHandle);
  return _result;
}
...
Milestone sdkNavigationMilestoneFromFfi(Pointer<Void> handle) {
  ...
  final _typeHandle = _sdkNavigationMilestoneGetFieldtype(handle);
  try {
    return Milestone.withType(
      (_sectionIndexHandle), 
      ...
      sdkNavigationMilestonetypeFromFfi(_typeHandle)
    );
  } finally {
