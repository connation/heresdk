...
@Deprecated("Will be removed in v4.20.0. Please use the method with [SpatialAudioCuePanning] listener instead.")
abstract class SpatialManeuverAudioCuePanning {
  ...
  /// When [CustomPanningData] is initialized as `null`, the default set of values provided by HERE SDK will be used instead.
  ///
