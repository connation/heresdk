...
class SpeedLimitOffset {
  ...
  /// [lowSpeedOffsetInMetersPerSecond] A speed limit offset for speed limits below the [SpeedLimitOffset.highSpeedBoundaryInMetersPerSecond].

  /// [highSpeedOffsetInMetersPerSecond] A speed limit offset for speed limits above the [SpeedLimitOffset.highSpeedBoundaryInMetersPerSecond].

  /// [highSpeedBoundaryInMetersPerSecond] The boundary that defines higher and lower speed limits.

  SpeedLimitOffset._(this.lowSpeedOffsetInMetersPerSecond, this.highSpeedOffsetInMetersPerSecond, this.highSpeedBoundaryInMetersPerSecond);
  SpeedLimitOffset()
