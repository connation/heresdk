...
class LaneDirectionCategory {
  ...
  /// [slightlyLeft] A lane that goes slightly left.

  /// [quiteLeft] A lane that goes quite left.

  /// [hardLeft] A lane that goes hard left.

  /// [uTurnLeft] A lane that makes a left u-turn.

  /// [slightlyRight] A lane that goes slightly right.

  /// [quiteRight] A lane that goes quite right.

  /// [hardRight] A lane that goes hard right.

  /// [uTurnRight] A lane that makes a right u-turn.
