...
/// For the `GPXTrack`, a speed is either based on timestamps in the original file or provided by the user.
///
/// Note that the `LocationSimulator` does not apply any interpolation on the provided location data.
///
...
abstract class LocationSimulator {
  ...
  ///
  /// Calling this function has no effect when location provider is not started.
  ///
  void pause();
...
final _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__Route_LocationSimulatorOptions_return_release_handle'));
final _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__Route_LocationSimulatorOptions_return_get_result'));
final _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__Route_LocationSimulatorOptions_return_get_error'));
final _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__Route_LocationSimulatorOptions_return_has_error'));


final _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__GPXTrack_LocationSimulatorOptions_return_release_handle'));
final _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__GPXTrack_LocationSimulatorOptions_return_get_result'));
final _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_LocationSimulator_make__GPXTrack_LocationSimulatorOptions_return_get_error'));
final _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class LocationSimulator$Impl extends __lib.NativeBase implements LocationSimulator {
  ...
  static Pointer<Void> _withRoute(Route route, LocationSimulatorOptions options) {
    ...
    if (_withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnGetError(__callResultHandle);
        _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnGetResult(__callResultHandle);
    _withRoutesdkNavigationLocationsimulatorMakeRouteLocationsimulatoroptionsReturnReleaseHandle(__callResultHandle);
  ...
  static Pointer<Void> _withTrack(GPXTrack gpxTrack, LocationSimulatorOptions options) {
    ...
    sdkNavigationLocationsimulatoroptionsReleaseFfiHandle(_optionsHandle);
    if (_withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnGetError(__callResultHandle);
        _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnGetResult(__callResultHandle);
    _withTracksdkNavigationLocationsimulatorMakeGpxtrackLocationsimulatoroptionsReturnReleaseHandle(__callResultHandle);
    return __resultHandle;
  }
  ...
  @override
  void pause() {
    final _pauseFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32), void Function(Pointer<Void>, int)>('here_sdk_sdk_navigation_LocationSimulator_pause'));
    final _handle = this.handle;
  ...
  @override
  void resume() {
    final _resumeFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32), void Function(Pointer<Void>, int)>('here_sdk_sdk_navigation_LocationSimulator_resume'));
    final _handle = this.handle;
