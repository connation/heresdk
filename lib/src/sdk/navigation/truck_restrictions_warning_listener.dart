...
abstract class TruckRestrictionsWarningListener {
  ...
  /// Called whenever the distance type ([TruckRestrictionWarning.distanceType]) of a truck
  /// restriction changes.
  ///
  /// If needed, it is up to the application to maintain a list of active
  /// warnings like the ones with [DistanceType.ahead] or [DistanceType.reached] based on the
  /// updates provided by this method.
  ///
  /// [restrictions] A list containing truck restriction warnings that have their distance
  /// type ([TruckRestrictionWarning.distanceType]) updated.
  ///
