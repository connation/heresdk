...
/// the first [SafetyCameraWarning.distanceToCameraInMeters] is 120 meters
/// and the next [SafetyCameraWarning.distanceToCameraInMeters] is then 40 meters,
/// since that is the distance between the first and second warnings.
///
/// When [SafetyCameraWarningListener] is enabled, a new set of text notifications (e.g. "Speed camera ahead") will be trigger under [ManeuverNotificationListener]
/// and/or [EventTextListener] if any has been also enabled.
