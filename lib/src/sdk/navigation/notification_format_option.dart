...
enum NotificationFormatOption {
    ...
    /// option is set to true. Notification example: '<speak>After 300 meters turn right onto `<lang xml:lang="ENG">
    /// <phoneme alphabet="nts" ph="&quot;wɔːl&quot;striːt" orthmode="ignorepunct">Wall Street</phoneme></lang>`.
    /// </speak>'. Some 3rd party
    /// TTS engines may support it. Please check <https://www.w3.org/TR/speech-synthesis11/> for detailed information
