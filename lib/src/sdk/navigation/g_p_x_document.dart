...
abstract class GPXDocument {
  ...
  ///
  /// [trackToAdd] track to add to GPX document
  ///
  void addTrack(GPXTrack trackToAdd);
...
final _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_fromString__String_GPXOptions_return_release_handle'));
final _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_fromString__String_GPXOptions_return_get_result'));
final _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_fromString__String_GPXOptions_return_get_error'));
final _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_fromString__String_GPXOptions_return_has_error'));


final _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_make__String_GPXOptions_return_release_handle'));
final _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_make__String_GPXOptions_return_get_result'));
final _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_navigation_GPXDocument_make__String_GPXOptions_return_get_error'));
final _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class GPXDocument$Impl extends __lib.NativeBase implements GPXDocument {
  ...
  GPXDocument fromString(String content, GPXOptions options) {
    final _fromStringFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_navigation_GPXDocument_fromString__String_GPXOptions'));
    final _contentHandle = stringToFfi(content);
    final _optionsHandle = sdkNavigationGpxoptionsToFfi(options);
    final __callResultHandle = _fromStringFfi(__lib.LibraryContext.isolateId, _contentHandle, _optionsHandle);
    stringReleaseFfiHandle(_contentHandle);
    sdkNavigationGpxoptionsReleaseFfiHandle(_optionsHandle);
    if (_fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnGetError(__callResultHandle);
        _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnGetResult(__callResultHandle);
    _fromStringsdkNavigationGpxdocumentFromstringStringGpxoptionsReturnReleaseHandle(__callResultHandle);
    try {
      return sdkNavigationGpxdocumentFromFfi(__resultHandle);
    } finally {
      sdkNavigationGpxdocumentReleaseFfiHandle(__resultHandle);
  ...
  static Pointer<Void> _$init(String gpxFilePath, GPXOptions options) {
    ...
    sdkNavigationGpxoptionsReleaseFfiHandle(_optionsHandle);
    if (_$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnGetError(__callResultHandle);
        _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnGetResult(__callResultHandle);
    _$initsdkNavigationGpxdocumentMakeStringGpxoptionsReturnReleaseHandle(__callResultHandle);
  ...
  @override
  void addTrack(GPXTrack trackToAdd) {
    final _addTrackFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_navigation_GPXDocument_addTrack__GPXTrack'));
    final _trackToAddHandle = sdkNavigationGpxtrackToFfi(trackToAdd);
    final _handle = this.handle;
    _addTrackFfi(_handle, __lib.LibraryContext.isolateId, _trackToAddHandle);
    sdkNavigationGpxtrackReleaseFfiHandle(_trackToAddHandle);
