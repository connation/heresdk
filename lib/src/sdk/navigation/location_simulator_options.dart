...
class LocationSimulatorOptions {
  ...
  LocationSimulatorOptions._(this.speedFactor, this.notificationInterval);
  LocationSimulatorOptions()
    : speedFactor = 1.0, notificationInterval = const Duration(milliseconds: 1000);
  @override
...
Pointer<Void> sdkNavigationLocationsimulatoroptionsToFfi(LocationSimulatorOptions value) {
  ...
  final _result = _sdkNavigationLocationsimulatoroptionsCreateHandle(_speedFactorHandle, _notificationIntervalHandle);
