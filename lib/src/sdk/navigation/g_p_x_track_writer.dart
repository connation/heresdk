...
///
/// The `GPXDocument` including all tracks is saved in the [GPX](https://www.topografix.com/gpx.asp) file format. Hence, once saved, it can be easily shared with other applications that understand the GPX file format.
