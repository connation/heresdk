...
class ManeuverProgress {
  ...
  /// [maneuverIndex] Index of the [Maneuver] being traversed along the route.
  /// Defaults to 0.

  /// [remainingDistanceInMeters] The distance in meters from current location until the [Maneuver].
  /// Defaults to 0.

  /// [remainingDuration] The estimated time in seconds for traversing the [Section]
  /// from current location until the [Maneuver] is reached,
  /// including traffic delays if available.
  /// Defaults to 0 seconds.

  ManeuverProgress._(this.maneuverIndex, this.remainingDistanceInMeters, this.remainingDuration);
  ManeuverProgress()
    : maneuverIndex = 0, remainingDistanceInMeters = 0, remainingDuration = const Duration(seconds: 0);
  @override
...
final _sdkNavigationManeuverprogressCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Int32, Int32, Uint64),
...
Pointer<Void> sdkNavigationManeuverprogressToFfi(ManeuverProgress value) {
  ...
  final _result = _sdkNavigationManeuverprogressCreateHandle(_maneuverIndexHandle, _remainingDistanceInMetersHandle, _remainingDurationHandle);
