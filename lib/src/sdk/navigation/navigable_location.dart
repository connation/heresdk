...
class NavigableLocation {
  ...
  /// [originalLocation] The original location that was passed in via [LocationListener].
  /// [mapMatchedLocation] The map-matched location on a road. It is calculated from the passed in [NavigableLocation.originalLocation].
