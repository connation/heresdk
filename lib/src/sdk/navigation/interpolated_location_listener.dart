...
///
/// The interpolated locations are only provided between
...
abstract class InterpolatedLocationListener {
  ...
  ///
  /// The interpolated locations are only provided between [VisualNavigator.startRendering] and
  /// [VisualNavigator.stopRendering] calls and the application is not running in the background.
  ///
