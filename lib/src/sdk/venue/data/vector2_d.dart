...
class Vector2D {
  ...
  ///
  double length() => $prototype.length(this);
  ...
  ///
  Vector2D normalize() => $prototype.normalize(this);
  ...
  ///
  Vector2D rotate(double angle) => $prototype.rotate(this, angle);
  ...
  ///
  double angle(Vector2D vector) => $prototype.angle(this, vector);
  ...
  ///
  Vector2D add(Vector2D vector) => $prototype.add(this, vector);
  ...
  ///
  Vector2D subtract(Vector2D vector) => $prototype.subtract(this, vector);
  ...
  ///
  Vector2D multiply(double value) => $prototype.multiply(this, value);
  ...
  ///
  Vector2D divide(double value) => $prototype.divide(this, value);
  ...
  ///
  static Vector2D scale(Vector2D left, Vector2D right) => $prototype.scale(left, right);
  ...
  /// right).
  ///
  static double dot(Vector2D left, Vector2D right) => $prototype.dot(left, right);
  @override
...
class Vector2D$Impl {
  ...
  Vector2D normalize(Vector2D $that) {
  ...
  Vector2D rotate(Vector2D $that, double angle) {
  ...
  double angle(Vector2D $that, Vector2D vector) {
  ...
  Vector2D add(Vector2D $that, Vector2D vector) {
  ...
  Vector2D subtract(Vector2D $that, Vector2D vector) {
  ...
  Vector2D multiply(Vector2D $that, double value) {
  ...
  Vector2D divide(Vector2D $that, double value) {
  ...
  Vector2D scale(Vector2D left, Vector2D right) {
