...
abstract class VenueLevel {
  ...
  List<VenueTopology> get topologies;
...
class VenueLevel$Impl extends __lib.NativeBase implements VenueLevel {
  ...
  @override
  VenueTopology? getTopologyByCoordinates(GeoCoordinates coordinates) {
    final _getTopologyByCoordinatesFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32, Pointer<Void>), Pointer<Void> Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_venue_data_VenueLevel_getTopologyByCoordinates__GeoCoordinates'));
    final _coordinatesHandle = sdkCoreGeocoordinatesToFfi(coordinates);
    final _handle = this.handle;
    final __resultHandle = _getTopologyByCoordinatesFfi(_handle, __lib.LibraryContext.isolateId, _coordinatesHandle);
    sdkCoreGeocoordinatesReleaseFfiHandle(_coordinatesHandle);
    try {
  ...
  @override
  List<VenueTopology> get topologies {
    final _getFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32), Pointer<Void> Function(Pointer<Void>, int)>('here_sdk_sdk_venue_data_VenueLevel_topologies_get'));
    final _handle = this.handle;
    final __resultHandle = _getFfi(_handle, __lib.LibraryContext.isolateId);
    try {
      return venuecoreBindingslistofSdkVenueDataVenuetopologyFromFfi(__resultHandle);
    } finally {
      venuecoreBindingslistofSdkVenueDataVenuetopologyReleaseFfiHandle(__resultHandle);
