...
abstract class VenueEngine {
  ...
  /// be started using one of its methods or using [VenueEngine.startWithToken].
  ///
...
final _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__VenueEngineInitCallback__return_release_handle'));
final _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__VenueEngineInitCallback__return_get_result'));
final _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__VenueEngineInitCallback__return_get_error'));
final _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__VenueEngineInitCallback__return_has_error'));


final _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__SDKNativeEngine_VenueEngineInitCallback__return_release_handle'));
final _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__SDKNativeEngine_VenueEngineInitCallback__return_get_result'));
final _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__SDKNativeEngine_VenueEngineInitCallback__return_get_error'));
final _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_venue_VenueEngine_make__SDKNativeEngine_VenueEngineInitCallback__return_has_error'));
...
class VenueEngine$Impl extends __lib.NativeBase implements VenueEngine {
  ...
  static Pointer<Void> _$init(VenueEngineInitCallback? callback) {
    ...
    final __callResultHandle = _$initFfi(__lib.LibraryContext.isolateId, _callbackHandle);
    sdkVenueVenueengineinitcallbackReleaseFfiHandleNullable(_callbackHandle);
    if (_$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnGetError(__callResultHandle);
        _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnGetResult(__callResultHandle);
    _$initsdkVenueVenueengineMakeVenueengineinitcallbackReturnReleaseHandle(__callResultHandle);
  ...
  static Pointer<Void> _withSdkEngine(SDKNativeEngine sdkEngine, VenueEngineInitCallback? callback) {
    ...
    final _callbackHandle = sdkVenueVenueengineinitcallbackToFfiNullable(callback);
    final __callResultHandle = _withSdkEngineFfi(__lib.LibraryContext.isolateId, _sdkEngineHandle, _callbackHandle);
    sdkCoreEngineSdknativeengineReleaseFfiHandle(_sdkEngineHandle);
    sdkVenueVenueengineinitcallbackReleaseFfiHandleNullable(_callbackHandle);
    if (_withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnGetError(__callResultHandle);
        _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnReleaseHandle(__callResultHandle);
        try {
          throw InstantiationException(sdkCoreErrorsInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkCoreErrorsInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnGetResult(__callResultHandle);
    _withSdkEnginesdkVenueVenueengineMakeSdknativeengineVenueengineinitcallbackReturnReleaseHandle(__callResultHandle);
    return __resultHandle;
  }
  ...
  @override
  void startWithToken(String token) {
    final _startWithTokenFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_venue_VenueEngine_start__String'));
    final _tokenHandle = stringToFfi(token);
    final _handle = this.handle;
    _startWithTokenFfi(_handle, __lib.LibraryContext.isolateId, _tokenHandle);
