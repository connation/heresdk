...
abstract class VenueThreading {
  ...
  static VenueThreads get factory => $prototype.factory;
  /// Sets the thread factory.
  static set factory(VenueThreads value) { $prototype.factory = value; }
...
class VenueThreading$Impl extends __lib.NativeBase implements VenueThreading {
  ...
  set factory(VenueThreads value) {
