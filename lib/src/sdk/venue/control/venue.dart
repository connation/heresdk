...
/// [VenueMap.addVenueAsyncWithErrors] and [VenueMap.selectVenueAsyncWithErrors].
...
class Venue$Impl extends __lib.NativeBase implements Venue {
  ...
  @override
  void setCustomStyleToTopology(List<VenueTopology> topologies, VenueGeometryStyle? style) {
    final _setCustomStyleToTopologyFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_venue_control_Venue_setCustomStyle__ListOf_sdk_venue_data_VenueTopology_VenueGeometryStyle_'));
    final _topologiesHandle = venuecoreBindingslistofSdkVenueDataVenuetopologyToFfi(topologies);
    final _styleHandle = sdkVenueStyleVenuegeometrystyleToFfiNullable(style);
    final _handle = this.handle;
    _setCustomStyleToTopologyFfi(_handle, __lib.LibraryContext.isolateId, _topologiesHandle, _styleHandle);
  ...
  @override
  bool get isTopologyVisible {
    final _getFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Uint8 Function(Pointer<Void>, Int32), int Function(Pointer<Void>, int)>('here_sdk_sdk_venue_control_Venue_isTopologyVisible_get'));
    final _handle = this.handle;
    final __resultHandle = _getFfi(_handle, __lib.LibraryContext.isolateId);
    try {
  ...
  @override
  set isTopologyVisible(bool value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Uint8), void Function(Pointer<Void>, int, int)>('here_sdk_sdk_venue_control_Venue_isTopologyVisible_set__Boolean'));
